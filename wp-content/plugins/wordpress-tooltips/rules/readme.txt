=== Smart Content Links ===
Please check our details at:
https://tooltips.org/product/smart-content-links/
...
https://tooltips.org/features-of-wordpress-tooltips-plugin/


== Changelog ==
= 3.0 =
In admin area, added new panel "Smart Keyword Links Search By AI",  Ranking posts based on the best match with keywords using AI calculations 
You will see the top 10 posts that best match your keyword or keyword phrase when entered.

= 2.0 =
Improved UI in admin area

= 1.9 =
New smart content link shortcode "scl", just insert the shortcode in your worpdress post to display smart content link
  
= 1.8 =
new Smart Content Link global settings panel
new option  "Enable Smart Content Link Bar Throughout the Whole Site"

Follow wordpress security standard to use sanitize_text_field enhance the security in back end

= 1.7 =
Follow wordpress security standard to use sanitize_text_field enhance the security in back end 

= 1.6 =
New  Smart Content Links with Custom Post Types Settings panel, 
opt to only add smart content links For specificed Post Types ( only support post type which follow wordpress stantard API "the_content" ) : 

= 1.5 =
Fixed a conflicts with wordpress tooltips glossary shortcode
 
= 1.4 =
Added placeholder to help users understand how to add new items
