...
<div class="container">
	<div id="header" class="menubar">
		<div class="header-menu <?php if( get_theme_mod( 'automotive_centre_sticky_header', false) == 1 || get_theme_mod( 'automotive_centre_stickyheader_hide_show', false) == 1) { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
			<div class="row">
				<div class="<?php if( get_theme_mod( 'automotive_centre_search_hide_show',true) == 1) { ?>col-lg-11 col-md-10 col-6"<?php } else { ?>col-lg-12 col-md-12 <?php } ?> ">
				...
				<div class="col-lg-1 col-md-2 col-6">
			        <?php if( get_theme_mod( 'automotive_centre_search_hide_show',true) == 1) { ?>
