...
<div class="container">
	<main id="maincontent" role="main" class="middle-align">
		<div class="row m-0">
			<?php if(get_theme_mod('automotive_centre_single_product_layout', 'Right Sidebar') == 'Right Sidebar'){ ?>
			...
			<?php } ?>
			<?php } elseif(get_theme_mod('automotive_centre_single_product_layout', 'Right Sidebar') == 'Left Sidebar') {?>
			<?php if ( 'Disable' != $automotive_centre_woocommerce_single_product_page_sidebar ) {?>
				<div id="sidebar" class="col-lg-4 col-md-4">
					<?php dynamic_sidebar('woocommerce-single-sidebar'); ?>
				</div>
