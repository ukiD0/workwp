jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_car_rental_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-car-rental-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-car-rental-plugin-install');
                button.addClass('button-primary vw-car-rental-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-car-rental-recommended-plugins .vw-car-rental-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-car-rental-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-car-rental-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-car-rental-recommended-plugins').css('display','none');
    });
