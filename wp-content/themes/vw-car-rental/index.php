...
<main id="maincontent" role="main">
  <div class="middle-align container">
    <?php
      $vw_car_rental_theme_lay = get_theme_mod( 'vw_car_rental_theme_options','Right Sidebar');
      if($vw_car_rental_theme_lay == 'Left Sidebar'){ ?>
      <div class="row m-0">
        ...
        <div id="our-services" class="services col-lg-8 col-md-8">
          ...
          ?>
          <?php if( get_theme_mod( 'vw_car_rental_blog_pagination_hide_show',true) == 1) { ?>
            <div class="navigation">
              <?php vw_car_rental_blog_posts_pagination(); ?>
      ...
      <div class="clearfix"></div>
    <?php }else if($vw_car_rental_theme_lay == 'Right Sidebar'){ ?>
      <div class="row m-0">
        <div id="our-services" class="services col-lg-8 col-md-8">
          <?php if ( have_posts() ) :
            /* Start the Loop */
    ...
    <?php }else if($vw_car_rental_theme_lay == 'One Column'){ ?>
    ...
    <?php }else if($vw_car_rental_theme_lay == 'Three Columns'){ ?>
      <div class="row m-0">
    ...
    <?php }else if($vw_car_rental_theme_lay == 'Four Columns'){ ?> 
      <div class="row m-0">
        <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
    ...
    <?php }else if($vw_car_rental_theme_lay == 'Grid Layout'){ ?>
      <div class="row m-0">
