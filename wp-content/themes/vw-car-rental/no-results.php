...
<h2 class="entry-title"><?php echo esc_html(get_theme_mod('vw_car_rental_no_results_page_title',__('Nothing Found','vw-car-rental')));?></h2>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<p><?php echo esc_html(get_theme_mod('vw_car_rental_no_results_page_content',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','vw-car-rental')));?></p><br />
		<?php get_search_form(); ?>
	<?php else : ?>
