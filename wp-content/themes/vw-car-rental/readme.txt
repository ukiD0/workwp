...
= 0.6.2 =
* Done slider & services sec button css of block pattern in tab media.
...
* Resolved error of when scroll search sticky header is dispalying in tab media.
* Added hover on logo.
...
== Fonts ==
* Source+Sans+Pro *
* Source : https://fonts.google.com/specimen/Source+Sans+Pro?query=Source+Sans+Pro
...
== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-car-rental/
