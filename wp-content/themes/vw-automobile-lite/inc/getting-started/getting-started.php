		...
		<div id="block_pattern" class="tabcontent">
			...
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vw_automobile_lite_plugin_custom_css); ?>">
				<div class="block-pattern-img">
              	...
              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon.','vw-automobile-lite'); ?></span></b></p>
              	<div class="vw-automobile-lite-pattern-page">
				    ...
				    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getting-started/images/block-pattern1.png" alt="" />
				    	<p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Sections >> Publish.','vw-automobile-lite'); ?></span></b></p>
