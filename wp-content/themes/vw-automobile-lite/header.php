...
<header role="banner">
            ...
            <?php $blog_info = get_bloginfo( 'name' ); ?>
              <?php if ( ! empty( $blog_info ) ) : ?>
                <?php if ( is_front_page() && is_home() ) : ?>
                  <?php if( get_theme_mod('vw_automobile_lite_logo_title_hide_show',true) == 1){ ?>
              ...
              ?>
              <?php if( get_theme_mod('vw_automobile_lite_tagline_hide_show',false) == 1){ ?>
  ...
  <?php if(get_theme_mod('vw_automobile_lite_loader_enable',false) == 1) { ?>
    <div id="preloader">
