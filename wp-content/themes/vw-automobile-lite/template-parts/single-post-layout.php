...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
    <div class="single-post">
            ...
            <?php if( get_theme_mod( 'vw_automobile_lite_single_postdate',true) == 1 || get_theme_mod( 'vw_automobile_lite_single_author',true) == 1 || get_theme_mod( 'vw_automobile_lite_single_comments',true) == 1 || get_theme_mod( 'vw_automobile_lite_single_time',true) == 1) { ?>
                <div class="metabox">
                    ...
                    <?php if(get_theme_mod('vw_automobile_lite_single_time',true)==1){ ?>
                      <i class="<?php echo esc_attr(get_theme_mod('vw_automobile_lite_single_time_icon','far fa-clock')); ?>"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
                    <?php } ?>
                </div>
            <?php } ?>
        </div>
        ...
        <?php if(has_post_thumbnail()) { ?>
            ...
            <hr>                 
        <?php } ?> 
        <?php if( get_theme_mod( 'vw_automobile_lite_single_post_category',true) == 1) { ?>
            <div class="single-post-category mt-3">
                <span class="category"><?php esc_html_e('Categories:','vw-automobile-lite'); ?></span>
                <?php the_category(); ?>
            </div>
        <?php }?>
        <div class="entry-content">
            <?php the_content(); ?>
            <?php if(get_theme_mod('vw_automobile_lite_toggle_tags',false)==1){ ?>
