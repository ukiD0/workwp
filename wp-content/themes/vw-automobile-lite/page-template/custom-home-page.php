...
<main id="maincontent" role="main">
	...
	<?php if( get_theme_mod( 'vw_automobile_lite_slider_hide_show', false) == 1 || get_theme_mod( 'vw_automobile_lite_resp_slider_hide_show', false) == 1) { ?>
	  	<section class="slider">
	  		<?php if(get_theme_mod('vw_automobile_lite_slider_type', 'Default slider') == 'Default slider' ){ ?>
	                ...
	                <?php } ?>
			            <div class="carousel-caption">
			              <div class="inner_carousel">
			              	<?php if( get_theme_mod('vw_automobile_lite_slider_title_hide_show',true) == 1){ ?>
			                ...
			                <?php } ?>
			                <?php if( get_theme_mod('vw_automobile_lite_slider_content_hide_show',true) == 1){ ?>
			                	<p class="wow swing delay-1000" data-wow-duration="2s"><?php $vw_automobile_lite_excerpt = get_the_excerpt(); echo esc_html( vw_automobile_lite_string_limit_words( $vw_automobile_lite_excerpt, esc_attr(get_theme_mod('vw_automobile_lite_slider_excerpt_number','30')))); ?></p>
			                <?php } ?>
	    	...
	    	<?php } else if(get_theme_mod('vw_automobile_lite_slider_type', 'Advance slider') == 'Advance slider'){?>
          <?php echo do_shortcode(get_theme_mod('vw_automobile_lite_advance_slider_shortcode')); ?>
        <?php } ?>
	  	</section> 
	<?php }?>
					    ...
					    $page_query = new WP_Query(array( 'category_name' => esc_html($vw_automobile_lite_catData1 ,'vw-automobile-lite')));?>
					  	<?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
					  		<div class="col-lg-4 col-md-4">
					    		...
					    		<p><?php $vw_automobile_lite_excerpt = get_the_excerpt(); echo esc_html( vw_automobile_lite_string_limit_words( $vw_automobile_lite_excerpt, esc_attr(get_theme_mod('vw_automobile_lite_services_excerpt_number','30')))); ?></p>
						    </div>
						<?php endwhile; 
						wp_reset_postdata();}
					?>
